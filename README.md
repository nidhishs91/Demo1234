(function process(
    ...
    try {
        ...
        if (
            ...
            throw new Error(
                'Unable to reload updated meeting.'
            );
        }
        ...
        return {
            ...
            meeting_number:
                updatedMeetingGR.getDisplayValue(
                    'number'
                ) || '',

            title:
                updatedMeetingGR.getValue(
                    'u_title'
                ) || '',
        ...
        return {
            ...
            message:
                'Unable to update the ServiceCall meeting.'
        };
    }
