    ...
    chatGroupLeaveButton.addEventListener("click", async () => {
      ...
      try {
        ...
        if (chatMessageInput) {
          ...
          chatMessageInput.placeholder = "Select a conversation";
        }
        ...
        /* -----------------------------------------
           ...
           Because membership is now inactive,
           /conversations should no longer return
           this group for the departing user.
        ----------------------------------------- */
