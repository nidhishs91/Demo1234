...
======================================================= */
  ...
  function openChatGroupDetails() {
    /*
     * Group Details can only be opened
     * for an existing group conversation.
     */
    if (
     ...
     * Temporary content.
     *
     * Real ServiceNow members will replace
     * this in the next backend step.
     */
