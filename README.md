...
async function checkNotificationsOnce() {
    ...
    if (
        ...
        console.log(
            'ServiceCall notification baseline established with no existing unread notifications.'
        );
    }
    ...
    return;
        ...
        /*
 * -----------------------------------------
 * INITIAL NOTIFICATION BASELINE
 * -----------------------------------------
 *
 * Existing unread notifications are NOT
 * necessarily new desktop notifications.
 *
 * On the first successful notification
 * check, remember everything that already
 * exists without showing desktop popups.
 */
...
if (
    ...
    console.log(
        'ServiceCall notification baseline established:',
        surfacedNotificationIds.size
    );
